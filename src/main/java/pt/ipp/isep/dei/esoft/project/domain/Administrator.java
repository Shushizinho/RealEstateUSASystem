...
/**
 * Represents a real estate administrador who can create and manage properties and announcements.
 */
public class Administrator implements Serializable {
    ...
    /**
     * Creates a new instance of Administrador with the provided information.
     *
     * @param employee the Employee that plays the role of this Administrador
     */
    ...
    /**
     * Checks if the given object is equal to this Administrador object
     * @param obj the object to be compared with this Administrador object
     * @return true if the given object is equal to this Administrador object, false otherwise
     */
    ...
    /**
     * Returns a hash code value for the Administrador object.
     * The hash code is based on the values of the employee field.
     *
     * @return the hash code value for this Administrador object
     */
    public int hashCode() {
    ...
    /**
     *Returns a clone of this Administrador. The clone has the same employee as this Administrador.
     * @return a clone of this Administrador
     */
    public Administrator clone() {
        return new Administrator(this.getEmployee());
    }
...
*/
  ...
  /*  public Optional<SaleAnnouncement> createSaleAnnouncement(String title, double price, DateTime date, double commission, BusinessType businessType, PropertyType propertyType, Property property, double listedPrice,Employee administrador){




        SaleAnnouncement saleAnnouncement = new SaleAnnouncement(title, price, date, commission, propertyType,businessType, property,administrador, listedPrice);
    ...
    *//**
     ...
     */
  /*  public Optional<RentAnnouncement> createRentAnnouncement(String title, double price, DateTime date, double commission, PropertyType propertyType, BusinessType businessType, Property property, Integer rentDuration,Employee administrador){

        RentAnnouncement rentAnnouncement = new RentAnnouncement(title, price, date, commission,propertyType,businessType,property,rentDuration,administrador);
    ...
    /**
     ...
     Adds a property to the list of properties of the administrador, if it's valid.
